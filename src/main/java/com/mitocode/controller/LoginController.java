...
public class LoginController {
	...
	public ResponseEntity<Integer> enviarCorreo(@RequestBody String correo) throws Exception {
		...
		if(us != null && us.getIdUsuario() > 0) {
			...
			Mail mail = new Mail();
			mail.setFrom("chilinssky@yahoo.com.mx.com");
			mail.setTo(us.getUsername());
			mail.setSubject("RESTABLECER CONTRASEÑA  MEDIAPP");
			
			Map<String, Object> model = new HashMap<>();
//			String url = "http://localhost:8080/#/recuperar/" + token.getToken();
			String url = "http://https://medicapp-backup-mcs.herokuapp.com/#/recuperar/" + token.getToken();
