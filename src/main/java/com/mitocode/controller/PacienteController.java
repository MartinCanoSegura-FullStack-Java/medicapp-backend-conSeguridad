...
public class PacienteController {
	...
	Logger loger = LoggerFactory.getLogger(This.class);
...
//		loger.info("p.id_paciente: " + p.getIdPaciente());
		
		List<Signos> signos = paciente.getSignos();
		signos.forEach(s -> {
			s.setPaciente(paciente);
		});
		
		paciente.setSignos(signos);
